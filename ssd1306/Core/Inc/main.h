...
#define SW_SET_Pin GPIO_PIN_6
#define SW_SET_GPIO_Port GPIOA
#define CHANGE_RESISTOR_Pin GPIO_PIN_7
#define CHANGE_RESISTOR_GPIO_Port GPIOA
#define LED_INFOR_Pin GPIO_PIN_15
#define LED_INFOR_GPIO_Port GPIOB
